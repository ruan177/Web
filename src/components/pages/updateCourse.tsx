  ...
  return (
    <>
      ...
      <div className="flex-grow flex dark:bg-grey-1000">
        {!preview && (
          <div className="flex-1 min-h-full border-1  dark:border-r-grey-600 ">
            <div className="flex justify-between items-center py-3 px-4 bg-grey-200 text-grey-500 dark:bg-grey-900">
              <label>
                Course Name: <input defaultValue={"some name course"}></input>
              </label>
        ...
        <div className="flex-1">
          ...
          <ReactMarkdown className="prose preview py-4 px-5 space-y-4 max-w-2xl mx-auto">
                        {BodyCourseContent}
          </ReactMarkdown>
        </div>
      </div>
